...
sudo aws s3 cp s3://build-niranjan-bucket-1/app.js /var/www/html/
sudo aws s3 cp s3://build-niranjan-bucket-1/package.json /var/www/html/
sudo aws s3 cp s3://build-niranjan-bucket-1/package-lock.json /var/www/html/
sudo aws s3 cp --recursive s3://build-niranjan-bucket-1/node_modules /var/www/html/node_modules
